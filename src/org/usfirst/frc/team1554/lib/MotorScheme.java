...
import static edu.wpi.first.wpilibj.RobotDrive.MotorType.*;
...
public interface MotorScheme extends Disposable {
    ...
    public enum DriveManager {
        ...
        MECANUM_CARTESIAN {
            @Override
            public void updateDrive(RobotDrive drive, JoystickControl c, BasicSense sense) {
        ...
        ARCADE {
            @Override
            public void updateDrive(RobotDrive drive, JoystickControl c, BasicSense s) {
         ...
         * @param c
         */
        public abstract void updateDrive(RobotDrive drive, JoystickControl c, BasicSense sense);
    }
    ...
    public static class Builder implements IBuilder<MotorScheme> {
         ...
         * @param frontRight - Front Right Wheel Motor
         ...
         * @param frontRightMotor - Front Right Wheel Channel
