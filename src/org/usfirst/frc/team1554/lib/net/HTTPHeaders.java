...
public interface HTTPHeaders {
    ...
    public static interface Request {
        ...
        /**
         * The MIME type of the body of the request (used with POST
         * and PUT requests).
         * <p>
        ...
        /**
         * The date and time that the message was sent (in "HTTP-date"
        ...
        /**
         * Indicates that particular server behaviors are required by
         * the client.
         * <p>
         ...
         * port number may be omitted if the port is the standard port
        ...
        /**
         * Only perform the action if the client supplied entity
         * matches the same entity on the server. This is mainly for
         * methods like PUT to only update a resource if it has not
        ...
        /**
         * If the entity is unchanged, send me the part(s) that I am
        ...
        /**
         * Only send the response if the entity has not been modified
         * since a specific time.
         * <p>
         * Example: If-Unmodified-Since: Sat, 29 Oct 1994 19:43:31
         * GMT
         */
        public static final String IfUnmodifiedSince = "If-Unmodified-Since";

        /**
         * Limit the number of times the message can be forwarded
         * through proxies or gateways.
         * <p>
        ...
        /**
         * Initiates a request for cross-origin resource sharing (asks
         * server for an 'Access-Control-Allow-Origin' response
         * field).
         * <p>
        ...
        /**
         * Implementation-specific fields that may have various
        ...
        /**
         * This is the address of the previous web page from which a
         * link to the currently requested page was followed. (The
         * word "referrer" has been misspelled in the RFC as well as
         * in most implementations to the point that it has become
         ...
         * server it expects to receive additional fields in the
         * trailer after the last, zero-sized, chunk.
         * <p>
         ...
         * <p>
         * Example: User-Agent: Mozilla/5.0 (X11; Linux x86_64;
        ...
        /**
         * Informs the server of proxies through which the request was
         * sent.
         * <p>
        ...
        /**
         * A general warning about possible problems with the entity
         * body.
         * <p>
    ...
    public static interface Response {
        /**
         * Specifying which web sites can participate in cross-origin
         * resource sharing.
         * <p>
        ...
        /**
         * Valid actions for a specified resource. To be used for a
        ...
        /**
         * Tells all caching mechanisms from server to client whether
         ...
         * a known MIME type with binary format or suggest a filename
         * for dynamic content. Quotes are necessary with special
         * characters.
         * <p>
         ...
         * P3P:CP="your_compact_policy". However, P3P did not take
         * off, most browsers have never fully implemented it, a lot
         * of websites set this field with fake policy text, that was
         * enough to fool browsers the existence of P3P policy and
        ...
        /**
         * If an entity is temporarily unavailable, this instructs the
         * client to try again later. Value could be a specified
         * period of time (in seconds) or a HTTP-date.
         * <p>
         * Example: Example 1: Retry-After: 120Example 2: Retry-After:
        ...
        /**
         * CGI header field specifying the status of the HTTP
         * response. Normal HTTP responses use a separate
         * "Status-Line" instead, defined by RFC 7230.
         * <p>
         ...
         * the HTTPS only policy and whether this applies to
         * subdomains.
         * <p>
         * Example: Strict-Transport-Security: max-age=16070400;
         * includeSubDomains
         */
        ...
        /**
         * The form of encoding used to safely transfer the entity to
         * the user. Currently defined methods are: chunked, compress,
        ...
        /**
         * Tells downstream proxies how to match future request
         * headers to decide whether the cached response can be used
        ...
        /**
         * Informs the client of proxies through which the response
         * was sent.
         * <p>
         * Example: Via: 1.0 fred, 1.1 example.com (Apache/1.1)
         */
        ...
        /**
         * Indicates the authentication scheme that should be used to
