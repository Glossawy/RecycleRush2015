...
/**
 * Defines minimal requirements of a Camera so that WPI's AxisCamera and USBCamera can be
 * interchanged and used in generalized interfaces with other Camera Implementations. 
 * 
 * @author Matthew
 *
 */
...
public interface Camera {
	...
	int getBrightness();
	/** Typically a Camera is connected using NIVision IMAQdx. If it is, this should return
	 * that ID. */
	int getID_IMAQdx();
	...
	/**
	 * From a {@link ByteBuffer} of JPEG Image Data this method will determing
	 * the JPEG size.
	 * @param data
	 * @return
	 */
	...
	/**
	 * If you have multiple Cameras, this method is a convenience method for creating names. 
	 * Typically the naming convention is equivalent to <code>"cam" + index</code>
	 * @param camIndex
	 * @return
	 */
