...
public class Vector3 implements Vector<Vector3> {
    ...
    public boolean isInline(Vector3 other) {
        return len2((this.y * other.z) - (this.z * other.y), (this.z * other.x) - (this.x * other.z), (this.x * other.y) - (this.y * other.x)) <= FloatingPoint.ERROR_64_BITS;
    }
    ...
    @Override
    public boolean equalsEpsilon(final Vector3 other, double epsilon) {
